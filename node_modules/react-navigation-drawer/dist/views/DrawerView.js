...
export default class DrawerView extends React.PureComponent {
  ...
  componentDidUpdate(prevProps) {
    ...
    const shouldClose = this._shouldClose(isDrawerOpen, wasDrawerOpen) || key !== prevKey;
  ...
  _shouldOpen = (isDrawerOpen, wasDrawerOpen) => {
    return isDrawerOpen && !wasDrawerOpen && (this._drawerState === 'closed' || this._drawerState === 'closing');
  };
